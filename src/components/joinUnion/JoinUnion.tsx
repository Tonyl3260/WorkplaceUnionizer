...
const JoinUnion = () => {
    ...
    const onSubmit = async () => {
        try {
            ...
            console.log("THIS IS BE ING SENT TO THE BACKEND: ", userUnionInfo)
            ...
            console.log("Union ID UFHJIUSHFIUSHFSJOIIIIIIIIIIIIIIIIIIIIIII");
            console.log("Union ID:", unionId);
            console.log("User UID:", user?.uid);
            console.log(unionId)
            if (unionId && user?.uid) {
                socketRef.current?.emit("union_join_notification", unionId, user?.uid)
            }
